...
/* ── Data ───────────────────────────────────────────────────────────── */
const ROLES = ['Full Stack Developer', 'Data Visualisation Analyst', 'Enterprise Systems Engineer', 'Power BI & Tableau Developer', 'Backend & API Developer']
    ...
    <section className="hero" id="home">
      <div className="hero-inner">
        <div>
          ...
          <h1>
            <span style={{display:'block',color:'var(--text2)',fontSize:'55%',fontWeight:400,marginBottom:6}}>Hi, I'm</span>
            <span className="name-grad">Amna Shahzad</span>
          </h1>
          <div className="hero-role">{role}<span className="cursor"/></div>
          <p className="hero-desc">
            Full-stack developer and data analyst from <span style={{color:'var(--text)',fontWeight:600}}>FAST NUCES</span> — building production-ready web applications and turning complex datasets into clear, interactive dashboards using Power BI, Tableau, and custom HTML/CSS.
          </p>
      ...
      <div className="about-grid">
        <FadeUp delay={100}>
          ...
          <div className="about-stats" style={{marginTop:28}}>
            {[['5+','Full-stack projects shipped'],['6+','Data dashboards built'],['4+','Industries analysed'],['10+','Technologies in daily use']].map(([n,l]) => (
      ...
      <div className="project-card">
        <div className="project-preview">
          ...
          {!p.comingSoon ? (
            ...
            <div className="project-links-overlay" style={{opacity:1,background:'rgba(5,10,20,0.65)'}}>
              <div style={{background:'rgba(255,255,255,0.08)',border:'1px solid rgba(255,255,255,0.15)',padding:'8px 20px',borderRadius:8,fontSize:13,fontWeight:600,color:'var(--text2)'}}>Coming soon</div>
            </div>
          )}
        </div>
    ...
    <section className="section-full projects-bg" id="projects">
      <div className="section-inner">
        <FadeUp>
          ...
          <p className="section-sub">Role-based, production-ready systems built with modern stacks — reflecting what real businesses require, not just demo projects.</p>
        </FadeUp>
  ...
  return (
    <section className="section" id="dataviz">
      <FadeUp>
        ...
        <p className="section-sub">Interactive dashboards built in Tableau, Power BI, and custom HTML/CSS — turning raw datasets into insights across automotive, entertainment, HR, and retail industries.</p>
      </FadeUp>
...
export default function App() {
  return (
    <>
      ...
      <div className="divider"/>
      <Contact/>
      <footer className="footer">© 2025 Amna Shahzad · Built with React + Vite · Deployed on Vercel</footer>
    </>
  )
}
